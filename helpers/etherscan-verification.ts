...
export const callAPIWithRetry = async (
  ...
  try {
    ...
    console.log(`${params.endpoint}/api?module=contract&action=verifyproxycontract&address=${params.address}&expectedimplementation=${params.expectedImplementation}&apikey=${params.apiKey}`);
    ...
    console.log("error when verifying proxy contract: ", err.message);
  }
};
